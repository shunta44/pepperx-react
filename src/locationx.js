...
<Card className={style.btnx}>
    ...
    九州・沖縄
      ...
      >
          ...
          {dd.map((i,index)=>(
        <MenuItem onClick={jack} id={index} value={10} key={index}>{i}</MenuItem>
              ))}
          </div>
      </Menu>
      ...
      >
          <div className={style.ss} onMouseLeave={handleClose}>
          {aa.map((i,index)=>(
        <MenuItem onClick={jack} id={index} value={20} key={index}>{i}</MenuItem>
      ...
      >
          <div className={style.ss} onMouseLeave={handleClose}>
          {ee.map((i,index)=>(
        <MenuItem onClick={jack} id={index} value={30} key={index}>{i}</MenuItem>
              ))}
      </div>
      </Menu>
      ...
      >
          <div className={style.ss} onMouseLeave={handleClose}>
          {cc.map((i,index)=>(
          <MenuItem onClick={jack} id={index} value={40} key={index}>{i}</MenuItem>
              ))}
      </div>
      </Menu>
      ...
      >
          <div className={style.ss} onMouseLeave={handleClose}>
          {bb.map((i,index)=>(
               <MenuItem onClick={jack} id={index} value={50} key={index}>{i}</MenuItem>
              ))}
      </div>
      </Menu>
      <Menu
      ...
      >
          <div className={style.ss} onMouseLeave={handleClose}>
          {ff.map((i,index)=>(
              <MenuItem onClick={jack} id={index} value={60} key={index}>{i}</MenuItem>
              ))}
      </div>
      </Menu>
      <Menu
      ...
      >
          <div className={style.ss} onMouseLeave={handleClose}>
          {gg.map((i,index)=>(
               <MenuItem onClick={jack} id={index} value={70} key={index}>{i}</MenuItem>
              ))}
      </div>
      </Menu>
      <Menu
      ...
      >
          <div className={style.ss} onMouseLeave={handleClose}>
          {hh.map((i,index)=>(
            <MenuItem onClick={jack} id={index} value={80} key={index}>{i}</MenuItem>
              ))}
      </div>
      </Menu> */}
